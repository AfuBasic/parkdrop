 ...
 * committed to — the names and phone number that will go out to their customers —
 * with an obvious way to fix a typo before any SMS is ever sent.
 */
export function ReadyScreen({
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 rounded-[var(--pd-field-radius)] border-2 border-[var(--pd-line-2)] bg-white divide-y divide-[var(--pd-line-2)]">
        ...
        {phone && (
          <div className="p-4 flex items-center justify-between gap-3.5">
            <div className="min-w-0">
              ...
              <p className="m-0 mt-0.5 text-[var(--pd-size-body)] font-extrabold text-[var(--pd-navy)] tabular-nums">
                {phone}
              </p>
            </div>
