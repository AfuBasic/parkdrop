        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 py-3.5 px-4 rounded-[var(--radius-xl)] bg-status-danger-text hover:bg-status-danger-text/90 active:scale-[0.99] text-white font-bold transition-all shadow-sm cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed text-sm flex items-center justify-center gap-2"
            >
