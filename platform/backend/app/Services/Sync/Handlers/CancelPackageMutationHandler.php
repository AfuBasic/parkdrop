...
class CancelPackageMutationHandler implements MutationHandler
{
    public function __construct(
        protected CancelPackageAction $cancelPackageAction
    ) {}
    ...
    public function handle(
        ...
        $validator = Validator::make($payload, [
            ...
            'reason' => 'required|string|in:DUPLICATE_RECORD,CREATED_BY_MISTAKE,PACKAGE_NOT_RECEIVED,WRONG_CUSTOMER,OTHER',
        ...
        try {
            $event = $this->cancelPackageAction->execute(
                $business,
                $package,
                [
                    'event_id' => $payload['event_id'],
                    'reason' => PackageCancelReason::from($payload['reason']),
