...
class RefundSmsAction
{
    /**
     * Refunds SMS credits to the business wallet.
     */
    public function execute(Business $business, int $amount = 1, ?string $referenceType = 'SMS_REFUND', ?string $referenceId = null): array
    {
